...
1. 🛠️ **Operational Mastery** - How you structure prompts and maintain coherent workflows
2. 🔍 **Evaluation Depth** - Your ability to critically assess AI outputs
3. 🧠 **Mental Model Alignment** - Understanding how LLMs actually work
4. 🗣️ **Linguistic Control** - Precision and efficiency in your instructions
5. 🧠 **Context Window Awareness** - Managing the model's memory constraints
6. 🎯 **Context Planning Precision** - Strategic information architecture
7. 🎷 **Linguistic Payload Capacity** - Expressive range and stylistic control (the "Jazz" dimension)
8. 🎲 **Collaborative Discovery** - Using AI as an exploration partner, not just an execution engine
9. 🪞 **Echo Chamber Resistance** - Avoiding sycophancy and maintaining epistemic hygiene
...
The evaluation uses a **contradiction-based scoring system**: each clear violation of best practices counts against your score. It's deliberately strict—favoring observed behavior over intent.
...
🔒 **100% Private**: This evaluation runs entirely within your own chat session. No data is sent to external services. The AI only analyzes what's already in your conversation history.
...
> "You tend to keep 'training wheels' in your prompts even after the AI understands what you want—removing them earlier frees up space and often produces cleaner output."
...
> "The AI is mirroring your framing back at you. Prompt adversarially—ask 'What's wrong with this idea?' and you'll get actual thinking instead of agreement."
